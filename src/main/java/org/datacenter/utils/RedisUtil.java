...
public class RedisUtil {
	 ...
	 *//**
		 ...
		 */
	/*
	 * public Set<String> keys(String key){ return redisTemplate.keys(key); }
	 * 
	 *//**
		 * 字符串获取值
		 * 
	 ...
	 * redisTemplate.opsForHash().put(key, filed, domain); redisTemplate.expire(key,
	 ...
	 *//**
		 ...
		 */
	/*
	 * public Object hget(String key,String field) { return
	 ...
	 *//**
		 ...
		 */
	/*
	 * public Object hget(String key) { return
	 ...
	 *//**
		 ...
		 * @param key 判断的key
		 *//*
			 * public Boolean hasKey(String key) { return
			 * redisTemplate.opsForHash().getOperations().hasKey(key); }
			 * 
			 */
}
